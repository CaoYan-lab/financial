...
function account(): LiveAccountDashboardResponse {
  return {
    ...
    summary: {
      ...
      dailyPnL: '$0.00',
      totalPnL: '$0.00',
      source: { source: 'test', accessedAt: new Date().toISOString(), timestamp: new Date().toISOString() },
      financingCurrency: 'USD',
      financingEquity: '$100,000.00',
      initialMargin: '$0.00',
      maintenanceMargin: '$0.00',
      futuExposureLevel: 'SAFE',
      futuRiskStatus: 'LEVEL1',
    },
    positions: [],
    risk: {
